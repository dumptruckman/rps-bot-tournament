...
- [x] The environment selects the latest upstream-supported Node.js LTS and an
...
- [x] The TypeScript compiler and all required build inputs are available to the
...
- [x] The TypeScript wrapper exposes the common strategy contract and its Seed
...
- [x] TypeScript Bot Artifacts can participate in mixed-language Tournament plans
...
- [x] No test or publication step fetches, imports, or inspects the TypeScript
