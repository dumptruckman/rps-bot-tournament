...
- [ ] Java selects the latest upstream-supported LTS release available when the
  work begins and pins exact Linux/AMD64 and Linux/ARM64 JDK build-toolchain and
  execution-runtime identities.
- [ ] The Team Source schema, networkless compilation recipe, fixed entrypoint,
  wrapper, readiness contract, and dependency policy are complete and
  organizer-owned.
- [ ] The Java wrapper exposes the common strategy contract and its Seed Adapter
...
- [ ] Java Bot Artifacts can participate in mixed-language Tournament plans and
...
- [ ] No test or publication step fetches, imports, or inspects the Java Team
  Template repository.
